<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <!-- <input type="text" placeholder="请输入验证码" v-model="code" @focus="getCode"> -->
        <!-- <img ref="code" src="http://182.92.128.115/api/user/passport/code" alt="code"> -->
        <!-- <span class="error-msg">错误提示信息</span>-->
        <input placeholder="请输入你的验证码" v-model="code" name="code" v-validate="{ required: true, regex: /^\d{6}$/ }"
          :class="{ invalid: errors.has('code') }" @focus="getCode">
      ...
      <div class="content">
        ...
        <span class="error-msg">错误提示信息</span> -->
        <input placeholder="请再输入确认密码" v-model="password1" name="password1" v-validate="{ required: true, is: password }"
      ...
      <div class="controls">
        ...
        <!-- <span class="error-msg">错误提示信息</span> -->
        <input type="checkbox" v-model="agree" name="agree" v-validate="{ required: true, agree: agree }"
